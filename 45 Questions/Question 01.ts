/* Install Node.js, TypeScript and VS Code on your computer.
  ...
  I have already installed Node.js on my computer, and I am sure about the version. 
 To check the installed version, I will use the command "node -v" in the terminal.
